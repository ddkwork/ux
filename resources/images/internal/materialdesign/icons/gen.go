...
// errSkip deliberately skips generating an images.
//
// When manually debugging one particular images, it can be useful to add
// something like:
//
...
func main() {
	...
	if err != nil {
		log.Fatalf("%v\n\nDid you override the -mdicons flag in images.go?\n\n", err)
	}
	defer f.Close()
...
type SVG struct {
	...
	// that doesn't happen in the specific case of the Material Design images.
