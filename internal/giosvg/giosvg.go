...
import (
	"bytes"
	"github.com/ddkwork/ux/internal/giosvg/internal/svgdraw"
...
// This is used to keep aspect ratio, and to keep the size of the images
...
// It will render the images based on the given layout.Constraints.Max.
