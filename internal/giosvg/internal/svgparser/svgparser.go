...
// is enough to draw many images. errMode determines if the images ignores, errors out, or logs a warning
// if it does not handle an element found in the images file.
