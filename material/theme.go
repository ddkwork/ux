...
type Theme struct {
	...
	TextSize unit.Sp
	Icon     struct {
		CheckBoxChecked   *giosvg.Icon
		CheckBoxUnchecked *giosvg.Icon
		RadioChecked      *giosvg.Icon
		RadioUnchecked    *giosvg.Icon
	}
...
func mustIcon(ic *giosvg.Icon, err error) *giosvg.Icon {
	if err != nil {
		panic(err)
	}
	return ic
