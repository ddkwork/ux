...
func treeTable() ux.Widget { // todo 调用抓包模块处理超长url
	...
	t.Root.AddChildByData(packet{Scheme: "http2", Method: http.MethodPut, Host: "example.com3", Path: "/api/v1/resource3", ContentType: "application/json3", ContentLength: 102, Status: http.StatusText(http.StatusOK), Note: "更新资源3", Process: "process3.exe", PadTime: 10})
	t.Root.AddChildByData(packet{Scheme: "http3", Method: http.MethodDelete, Host: "example.com4", Path: "/api/v1/resource4", ContentType: "application/json4", ContentLength: 103, Status: http.StatusText(http.StatusOK), Note: "删除资源4", Process: "process4.exe", PadTime: 5})
	t.Root.AddChildByData(packet{Scheme: "https4", Method: http.MethodGet, Host: "example.com5", Path: "/api/v1/resource5", ContentType: "application/json5", ContentLength: 104, Status: http.StatusText(http.StatusOK), Note: "获取资源5", Process: "process5.exe", PadTime: 30})
	t.Root.AddChildByData(packet{Scheme: "https5", Method: http.MethodPost, Host: "example.com6", Path: "/api/v1/resource6", ContentType: "application/json6", ContentLength: 105, Status: http.StatusText(http.StatusOK), Note: "创建资源6", Process: "process6.exe", PadTime: 20})
	t.Root.AddChildByData(packet{Scheme: "https6", Method: http.MethodPut, Host: "example.com7", Path: "/api/v1/resource7", ContentType: "application/json7", ContentLength: 106, Status: http.StatusText(http.StatusOK), Note: "更新资源7", Process: "process7.exe", PadTime: 10})
	t.Root.AddChildByData(packet{Scheme: "https7", Method: http.MethodDelete, Host: "example.com8", Path: "/api/v1/resource8", ContentType: "application/json8", ContentLength: 107, Status: http.StatusText(http.StatusOK), Note: "删除资源8", Process: "process8.exe", PadTime: 5})
