...
func NewSearchDropDownWithoutBorder() *SearchDropDown {
	c := &SearchDropDown{
		...
		cornerRadius: unit.Dp(4),
		// dragWidth:        th.Size.DefaultElementWidth,
		SearchInput: NewInput("Search..."),
	}
	return c
}
...
func (c *SearchDropDown) box1(gtx layout.Context, text string, maxWidth unit.Dp) layout.Dimensions {
	...
	return c.SearchDropDown.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
		...
		return border.Layout(gtx, func(gtx layout.Context) layout.Dimensions {
			// calculate the minimum dragWidth of the box, considering icon and padding
...
//func (c *SearchDropDown) box(gtx layout.Context, text string, dragWidth unit.Dp) layout.Dimensions {
//	c.SearchInput.SetWidth(c.dragWidth).SetHasBorder(false)
//	return c.SearchInput.Layout(gtx)
//}
